...
import com.example.mp_project.*;
import com.example.mp_project.exception.*;
...
public class ClashAPIImpl implements ClashAPI {
    ...
    public Clan requestClan(ClanData clan) throws IOException, ClashException, JSONException {
        return requestClan(clan.getTag());
    }

    public Clan requestClan(String clanTag) throws IOException, ClashException, JSONException {
        return new ClanImpl(performAPIRequest("clans/%s", clanTag));
    }

    public List<ClanMember> requestClanMembers(ClanData clan) throws IOException, ClashException, JSONException {
        return requestClanMembers(clan.getTag());
    }

    public List<ClanMember> requestClanMembers(String clanTag) throws IOException, ClashException, JSONException {
    ...
    public List<ClanLocation> requestLocations() throws IOException, ClashException, JSONException {
    ...
    public List<AbbreviatedClan> requestTopClans(ClanLocation location) throws IOException, ClashException, JSONException {
        return requestTopClans(location.getId());
    }

    public List<AbbreviatedClan> requestTopClans(int locationId) throws IOException, ClashException, JSONException {
    ...
    public List<LeaderboardPlayer> requestTopPlayers(ClanLocation location) throws IOException, ClashException, JSONException {
        return requestTopPlayers(location.getId());
    }

    public List<LeaderboardPlayer> requestTopPlayers(int locationId) throws IOException, ClashException, JSONException {
    ...
    public List<AbbreviatedClan> searchClans(ClanSearchRequest request) throws IOException, ClashException, JSONException {
